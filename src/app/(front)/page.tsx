    ...
    <div>
      ...
      <div className="m-auto flex justify-center mt-16">
        <div className="h-[500px] w-[90%] bg-primary-foreground rounded-[2rem] flex">
          ...
          <div className="flex flex-col mt-20 mr-20 gap-y-2">
            <div className="flex w-[450px] h-[70px] bg-background">
      ...
      <div className="m-auto flex justify-center mt-16">
        <div className="h-[500px] w-[90%] bg-primary-foreground rounded-[2rem] flex">
          ...
          <img className="h-[250px] w-[250] bg-primary-foreground" src="/RoundedSQPic.png"></img>
        </div>
        </div>
      </div>

      <div className="w-full flex justify-center mt-48">
            <h1 className="text-8xl font-extrabold z-50">
              LATEST WORK
            </h1>
